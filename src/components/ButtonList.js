...
const ButtonList = () => {
    ...
    return (
        <div className="relative my-2 mr-4">
            {/* 👆 shrink width slightly (95%), centered */}
            ...
            {/* Left Arrow */}
            {showLeftArrow && (
                <div className="absolute left-1 top-1/2 -translate-y-1/2 -translate-x-1/2 z-20">
                    {/* 👆 half circle outside container */}
                    <button
                        onClick={() => scroll("left")}
